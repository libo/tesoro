...
ActiveRecord::Schema.define(version: 2020_07_19_163656) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal "price_discounted", precision: 8, scale: 4, default: "0.0"
    t.boolean "include_discount", default: false
  end
