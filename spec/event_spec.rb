...
describe Event do
  ...
  it "passes Lars example 1" do
    ...
    Event.create(user: user, stock: zen, action: :buy, quantity: 100, price: 2, executed_on: 10.days.ago)
    Event.create(user: user, stock: zen, action: :buy, quantity: 200, price: 5, executed_on: 9.days.ago)
    ...
    e4 = Event.create(user: user, user: user, stock: zen, action: :sell, quantity: 350, price: 4.3, executed_on: 5.days.ago)
  ...
  it "passes Lars example 2" do
    ...
    Event.create(user: user, stock: zen, action: :buy, quantity: 100, price: 95, executed_on: 10.days.ago)
    Event.create(user: user, stock: zen, action: :buy, quantity: 200, price: 105, executed_on: 9.days.ago)
    Event.create(user: user, stock: zen, action: :buy, quantity: 100, price: 107, executed_on: 8.days.ago)
    ...
    e4 = Event.create(user: user, user: user, stock: zen, action: :sell, quantity: 150, price: 110, executed_on: 5.days.ago)
    ...
    Event.create(user: user, stock: zen, action: :buy, quantity: 50, price: 100, executed_on: 4.days.ago)
    Event.create(user: user, stock: zen, action: :buy, quantity: 300, price: 107.5, executed_on: 3.days.ago)
    ...
    e7 = Event.create(user: user, stock: zen, action: :sell, quantity: 200, price: 108, executed_on: 2.days.ago)
